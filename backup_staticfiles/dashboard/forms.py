...
class OrderForm(forms.ModelForm):
	class Meta:
		model = Order
		fields = [
			'customer', 'product_name', 'product_model', 'quantity', 'unit_price',
			'order_status', 'payment_status', 'shipping_address', 'notes'
		]
		widgets = {
			'customer': forms.Select(attrs={'class': 'form-control'}),
			'product_name': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. iPhone 15 Pro Max'}),
			'product_model': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. A3108'}),
